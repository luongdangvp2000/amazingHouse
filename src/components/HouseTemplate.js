        ...
        <>
            ...
            <Container>
                <Row className="gardenHouse">
                    <Col><Image className="gardenHouse-img" src='/images/gardenHouse.jpg' alt="gardenHouse" /></Col>
                    <Col>
                ...
                <Row className="aparment">
                    ...
                    <Col><Image className="apartment-img" src='/images/apartment.jpg' alt="apartment" /></Col>
                </Row>
                <Row className="miniApartment">
                    <Col><Image className="miniApartment-img" src="/images/miniApartment.jpg" alt="miniApartment" /></Col>
                    <Col>
